...
typedef struct
{
		const ext_power_heat_data_t *power_heat_data_pointer; //IMU角度指针 	
		const ext_game_robot_state_t *robot_state_pointer;
		const float *voltage_pointer; // 超级电容电压
...
void ANODT_SendF2(u16 _a, u16 _b, u8 _c,u16 _d,u16 _e);
