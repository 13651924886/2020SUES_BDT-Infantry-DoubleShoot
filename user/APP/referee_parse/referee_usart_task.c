...
//	client_com_graphic_single.interactData.graphic_data_struct.graphic_type = 5; // fp_num
...
//	client_com_graphic_single.interactData.graphic_data_struct.start_angle = 10;
//	client_com_graphic_single.interactData.graphic_data_struct.end_angle = 2;
//	client_com_graphic_single.interactData.graphic_data_struct.width = 1;
//	client_com_graphic_single.interactData.graphic_data_struct.start_x = 1260;
//	client_com_graphic_single.interactData.graphic_data_struct.start_y = 640;
//	client_com_graphic_single.interactData.graphic_data_struct.radius = 0x42C90000 & 0x03FF;
//	client_com_graphic_single.interactData.graphic_data_struct.end_x = (0x42C90000 >> 10)&(0x07FF);
//	client_com_graphic_single.interactData.graphic_data_struct.end_y = 0x42C90000 >> 21;
	
	client_com_graphic_single.interactData.graphic_data_struct.graphic_name[0] = 1;
	client_com_graphic_single.interactData.graphic_data_struct.operate_type = 1;
	client_com_graphic_single.interactData.graphic_data_struct.graphic_type = 0;
	client_com_graphic_single.interactData.graphic_data_struct.layer = 0;
	client_com_graphic_single.interactData.graphic_data_struct.color = 2;
	client_com_graphic_single.interactData.graphic_data_struct.start_angle = 20;
	client_com_graphic_single.interactData.graphic_data_struct.end_angle = 2;
	client_com_graphic_single.interactData.graphic_data_struct.width = 2;
	client_com_graphic_single.interactData.graphic_data_struct.start_x = 0; //1260
	client_com_graphic_single.interactData.graphic_data_struct.start_y = 0; //640
//	client_com_graphic_single.interactData.graphic_data_struct.radius = 0x404AE147 & 0x03FF;
//	client_com_graphic_single.interactData.graphic_data_struct.end_x = (0x404AE147 >> 10)&(0x07FF);
//	client_com_graphic_single.interactData.graphic_data_struct.end_y = 0x404AE147 >> 21;
	client_com_graphic_single.interactData.graphic_data_struct.radius = 0;
	client_com_graphic_single.interactData.graphic_data_struct.end_x = 500;
	client_com_graphic_single.interactData.graphic_data_struct.end_y = 500;
